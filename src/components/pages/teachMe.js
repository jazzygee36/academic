    ...
    <div className="teachMeBg pt-5 pb-5">
      <Container>
        ...
        <p className="text-center">
          ...
          homes, and communities using technology and innovation to improve the
          quality of education at all levels for for both the old and young. We
          leverage cutting edge technologies to make the learning environment
          suitable for all. We equally provise capacity building programmes to
          teachers, students, and other stakeholders to support them in
        ...
        <Row>
          <Col className="teachMeBox p-5 mb-4" lg="4" md="4" sm="12">
            ...
            <p>
              ...
              in education, such that teachers, learners and other stakeholders
              can reap the dividends of true quality education.
            </p>
          </Col>
          <Col className="teachMeBox p-5 mb-4 " lg="4" md="4" sm="12">
            ...
            <p>
              ...
              resourceful enough to inspire more creative and productive minds.
            </p>
          </Col>
          <Col className="teachMeBox p-5 " lg="4" md="4" sm="12">
            ...
            <p>
              At CodingTekAcademic, Education is our core business, because the
              Education of the mind is First among other things.
            </p>
          </Col>
        </Row>
      </Container>
